-- 1. Créer une table pays avec 2 champs : code
CREATE TABLE pays (code_pays CHAR(4) NOT NULL PRIMARY KEY, nom_pays VARCHAR(40));
---     pays (4 caractères, clé primaire), nom pays (40
---     caractères maximum)
--- 2. Ajouter une colonne courriel (60 caractères
---     possibles) à la table CLIENTS. Puis la modifier
---     pour passer à 75 caractères. Pour finir,
...
3. CREATE VIEW V_CLIENTS_PROVINCE AS
